    ...
    <div className="min-h-screen bg-[#080d1a] flex">
      ...
      <div className="hidden lg:flex flex-col justify-between w-1/2 p-14 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-lg">
          <div className="inline-block text-xs font-medium text-violet-400 bg-violet-400/10 border border-violet-400/20 px-3 py-1 rounded-full mb-6 tracking-widest uppercase">
            Powered by AI
          </div>
          ...
          <p className="text-slate-400 text-lg leading-relaxed mb-10">
            The AI-powered hiring platform that matches top developers with the
            right companies — in minutes, not months.
          </p>
