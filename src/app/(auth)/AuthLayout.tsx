...
export function AuthLayout({
  ...
  return (
    <div className="min-h-screen bg-background relative overflow-hidden">
      {/* Layer 1: Background decoration — পুরো viewport জুড়ে, edge-to-edge */}
      <div className="absolute top-[-80px] left-[-80px] w-[400px] h-[400px] bg-[var(--brand)]/10 rounded-full blur-3xl pointer-events-none z-0" />
      <div className="absolute bottom-[-60px] right-[-60px] w-[300px] h-[300px] bg-muted rounded-full blur-3xl pointer-events-none z-0" />
      <div
      ...
      <div className="relative z-10 flex justify-center min-h-screen">
        <Container className="flex">
          {/* Left Side */}
          <div className="hidden lg:flex flex-col w-1/2 py-14 pr-14">
